      ...
      <div className="min-h-scree p-4 md:p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
              ...
              <div className="flex gap-2">
                {(["Weekly", "Monthly"] as const).map((tab) => (
                  <button
                    key={tab}
                    onClick={() =>
                      handleTabChange(tab.toLowerCase() as TabType)
                    }
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 md:p-8">
            <h3 className="text-xl font-bold text-gray-900 mb-6 flex  gap-2 items-center">
              <FaEarthAsia /> Regional Health
            </h3>
            ...
            <div className="mt-6">
              <div className=" ">
                <img src={Screen} alt="" className=" rounded-xl" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 md:p-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            <h3 className="text-2xl font-bold text-gray-900 pl-4">
              Recent Critical Alerts
            </h3>
            <button className=" cursor-pointer flex gap-1 items-center text-emerald-600 hover:text-emerald-700 font-semibold transition-colors">
              View All Logs <FaArrowRightLong />
            </button>
          </div>
